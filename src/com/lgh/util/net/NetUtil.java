...
//                        LogUtil.info("the download speed:" + changeFluxUnit(nextReceived - preReceived, "kb") + "KB" + " 上传:" + changeFluxUnit(nextSent - preSent, "kb") + "KB");
...
//        saveProperties(new File("c://lgh.properties"), p);
    /**日期**/
    //        LogUtil.info(Util.getDate(new SimpleDateFormat("yy年MM月dd日"), new Date()));
    /**获得网卡地址**/
//        LogUtil.info(getMACAddress());
    }
}
